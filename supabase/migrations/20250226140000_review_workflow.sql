...
-- Tables: revisions, approvals, conflict_log
...
CREATE TABLE IF NOT EXISTS revisions (
  ...
  intent TEXT NOT NULL DEFAULT 'rephrase' CHECK (intent IN ('clarify', 'expand', 'shorten', 'rephrase', 'upgrade_difficulty', 'adjust_tone')),
...
-- Conflict log (concurrent edit conflicts)
